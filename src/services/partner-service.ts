...
export class PartnerService {
  ...
  getPartners(location, bucket, searchTerm, showOnlyPartnersWithCampaign): Observable <any> {
    let post = new GetPartnersPost(location, bucket, searchTerm, showOnlyPartnersWithCampaign);
